...
#'   \item \code{\link{mmplot_locator}}: Adds "locator" functionallity to plots made with ggplot2.
#'   \item \code{\link{mmplot_pairs}}: Pairs plot.
#'   \item \code{\link{mmplot_network}}: Network plot.
#'   \item \code{\link{mmextract}}: Extracts a subset of scaffolds based on input from \code{\link{ggplot_locator}}.
#'   \item \code{\link{mmextract_network}}: Extracts PE connected scaffolds.
