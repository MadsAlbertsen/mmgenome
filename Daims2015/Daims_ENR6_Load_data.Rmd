---
title: "Load - Daims Nitrospira Comammox ENR6 assembly"
...
## Load data
The assembly of the ENR6 metagenome in fasta format is loaded in fasta using the Biostrings package.
```{r Load_assembly}
...
```{r Save_data}
rm(list = c("ess", "ENR4A", "ENR4E", "ENR4F", "tax", "ENR6"))
save.image(file="Daims_ENR6.RData")
```