---
title: "Analysis - Daims Alphaproteobacteria ENR4 assembly"
...
## Introduction
This report documents the binning of a Alphaproteobacterial genome from an enrichment reactor (ENR4).See [Daims et al., 2015: Complete Nitrification by Nitrospira Bacteria](https://doi.org/10.1038/nature16461) for further details.
...
## Alphaproteobacteria
The combination of the coverage of sample `ENR4A` and `ENR4E` provides the cleanest separation of the genomes and are used for binning. A subspace is defined that clearly seperates the Alphaproteobacteria from the three other species.
