---
title: "Load - Daims Nitrospira Comammox GWW assembly"
...
```{r Load_coverage}
HPD <- read.table("data/HPD.csv", header = T, sep = ",")[,c("Reference.sequence", "Average.coverage")]
HPF1 <- read.table("data/HPF1.csv", header = T, sep = ",")[,c("Reference.sequence", "Average.coverage")]
```
...
```{r Save_data}
rm(list = c("ess", "HPD", "HPF1", "rRNA16S", "tax"))
save.image(file="Daims_GWW.RData")
```